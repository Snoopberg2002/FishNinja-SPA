...
export default function NewsFeed() {
  let url =
    "https://newsapi.org/v2/everything?q=fishing&apiKey=ce592c9e9c6441cca100f4bc925f4273/:splat 200";

  let req = new Request(url);
  let stories = [];
  fetch("https://newsapi.org/v2/everything?q=fishing&apiKey=ce592c9e9c6441cca100f4bc925f4273", 
  {
    // headers: {
